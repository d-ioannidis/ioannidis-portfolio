...
.pulse {
  ...
  border-radius: 50%;
  margin-right: 8px;
  box-shadow: 0 0 0 5px rgba(67, 204, 107, 0.14);
}
h1,
h2,
h3,
...
.orb {
  ...
  place-items: center;
  background:
    radial-gradient(circle, #4057ff 0 25%, transparent 26%),
    repeating-radial-gradient(
      circle,
      rgba(215, 255, 67, 0.75) 0 1px,
...
.blog-footer-inner > div:last-child {
  display: flex;
  gap: 25px;
  font-size: 13px;
}
